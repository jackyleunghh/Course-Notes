...
\begin{tikzpicture}[
    ...
    \draw[black, green arrow] (root) -- (eve_bot) node[midway, above right] {$R$};
    ...
    \node[right, draw=gamegreen, ellipse, line width=1.3pt, inner sep=3pt] at (leaf4) {1 \quad \textcolor{red}{2}};
