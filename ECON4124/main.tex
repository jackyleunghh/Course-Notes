...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \end{cases}
        \]
        \item Solving, we can find \(U_i(C) \ge U_i(D_k)\) if and only if \(\delta \ge \frac{1}{2}\). 
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Theorem 6.3. (Mininax Theorem)} If \(u_1(a_1, a_2) = -u_2(a_1, a_2)\) for all \(a_1 \in A_1\) and \(a_2 \in A_2\), then:
    \[
