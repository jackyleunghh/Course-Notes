...
\begin{tikzpicture}[
    ...
    % Nodes & Labels (Beliefs in green: p and 1-p)
    \node[dot=black, label=left:Student] at (root) {};
    \node[dot=red, label={[red]above left:Prof}, label={[gamegreen]above right:$p$}] at (qg_top) {};
    \node[dot=red, label={[gamegreen]above right:$1-p$}] at (qg_mid) {};
